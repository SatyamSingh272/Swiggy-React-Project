...
export default function Header(){
    ...
    return(
        <header className="bg-[#ff5200] font-serif">
            ...
            <div className="flex justify-between container mx-auto py-8 font-bold">
            ...
            <div className="max-w-[60%] container mx-auto flex justify-between mt-2 pb-8">
                <input className="bg-white w-[40%] text-xl px-6 py-4 rounded-2xl" placeholder="Enter your delivery location"></input>
                <input className="bg-white w-[55%] text-xl px-6 py-4 rounded-2xl" placeholder="Search for restaurants,items or more"></input>
            </div>
